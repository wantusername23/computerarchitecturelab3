...
/**
  ...
  * From within sbt use:
  * {{{
  * testOnly dinocpu.SingleCycleRTypeTesterLab3
  * }}}
  * From a terminal shell use:
  * {{{
  * sbt 'testOnly dinocpu.SingleCycleRTypeTesterLab3'
  * }}}
  */
class SingleCycleRTypeTesterLab3 extends CPUFlatSpec {
...
/**
  ...
  * From within sbt use:
  * {{{
  * testOnly dinocpu.SingleCycleITypeTesterLab3
  * }}}
  * From a terminal shell use:
  * {{{
  * sbt 'testOnly dinocpu.SingleCycleITypeTesterLab3'
  * }}}
  *
*/
class SingleCycleITypeTesterLab3 extends CPUFlatSpec {
...
/**
  ...
  * From within sbt use:
  * {{{
  * testOnly dinocpu.SingleCycleLoadTesterLab3
  * }}}
  * From a terminal shell use:
  * {{{
  * sbt 'testOnly dinocpu.SingleCycleLoadTesterLab3'
  * }}}
  *
*/
class SingleCycleLoadTesterLab3 extends CPUFlatSpec {
...
/**
  ...
  * From within sbt use:
  * {{{
  * testOnly dinocpu.SingleCycleUTypeTesterLab3
  * }}}
  * From a terminal shell use:
  * {{{
  * sbt 'testOnly dinocpu.SingleCycleUTypeTesterLab3'
  * }}}
  *
*/
class SingleCycleUTypeTesterLab3 extends CPUFlatSpec {
...
/**
  ...
  * From within sbt use:
  * {{{
  * testOnly dinocpu.SingleCycleStoreTesterLab3
  * }}}
  * From a terminal shell use:
  * {{{
  * sbt 'testOnly dinocpu.SingleCycleStoreTesterLab3'
  * }}}
  *
*/
class SingleCycleStoreTesterLab3 extends CPUFlatSpec {
...
/**
  ...
  * From within sbt use:
  * {{{
  * testOnly dinocpu.SingleCycleLoadStoreTesterLab3
  * }}}
  * From a terminal shell use:
  * {{{
  * sbt 'testOnly dinocpu.SingleCycleLoadStoreTesterLab3'
  * }}}
  *
*/
class SingleCycleLoadStoreTesterLab3 extends CPUFlatSpec {
...
/**
  ...
  * From within sbt use:
  * {{{
  * testOnly dinocpu.SingleCycleBranchTesterLab3
  * }}}
  * From a terminal shell use:
  * {{{
  * sbt 'testOnly dinocpu.SingleCycleBranchTesterLab3'
  * }}}
  *
*/
class SingleCycleBranchTesterLab3 extends CPUFlatSpec {
  behavior of "Single Cycle CPU"
...
/**
  ...
  * From within sbt use:
  * {{{
  * testOnly dinocpu.SingleCycleJALTesterLab3
  * }}}
  * From a terminal shell use:
  * {{{
  * sbt 'testOnly dinocpu.SingleCycleJALTesterLab3'
  * }}}
  *
*/
class SingleCycleJALTesterLab3 extends CPUFlatSpec {
...
/**
  ...
  * From within sbt use:
  * {{{
  * testOnly dinocpu.SingleCycleJALRTesterLab3
  * }}}
  * From a terminal shell use:
  * {{{
  * sbt 'testOnly dinocpu.SingleCycleJALRTesterLab3'
  * }}}
  *
*/
class SingleCycleJALRTesterLab3 extends CPUFlatSpec {
...
/**
  ...
  * From within sbt use:
  * {{{
  * testOnly dinocpu.SingleCycleApplicationsTesterLab3
  * }}}
  * From a terminal shell use:
  * {{{
  * sbt 'testOnly dinocpu.SingleCycleApplicationsTesterLab3'
  * }}}
  *
*/
class SingleCycleApplicationsTesterLab3 extends CPUFlatSpec {
